...
void *broadcast_server_address(void *arg)
{
    ...
    sendString = runtime_input;             /* Third arg:  string to broadcast */
    ...
    while(broadcast_flag) /* Run forever */
        {
         /* Broadcast sendString in datagram to clients every 3 seconds*/
           if (sendto(broadcast_sock, sendString, sendStringLen, 0, (struct sockaddr *) 
